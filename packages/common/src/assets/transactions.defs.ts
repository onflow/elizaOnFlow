...
import acctPoolEVMTransferERC20 from "./cadence/transactions/account-pool/evm/transfer_erc20.cdc?raw";
import acctPoolFlowTokenDynamicTransfer from "./cadence/transactions/account-pool/flow-token/dynamic_vm_transfer.cdc?raw";
import acctPoolFTGenericTransfer from "./cadence/transactions/account-pool/ft/generic_transfer_with_address.cdc?raw";
